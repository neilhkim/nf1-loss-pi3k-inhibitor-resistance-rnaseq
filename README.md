...
![PCA](readme_previews/pca_group.png)

#### Volcano plot (NF1KO_BYL vs CTRL_BYL)
![Volcano](readme_previews/volcano_NF1KO_BYL_vs_CTRL_BYL_labeled.png)

#### Hallmark GSEA dotplot
![GSEA](readme_previews/GSEA_Hallmark_NF1KO_BYL_vs_CTRL_BYL_dotplot.png)

#### Heatmap of top DE genes
![Heatmap](readme_previews/heatmap_NF1KO_BYL_vs_CTRL_BYL_top50.png)

#### KEGG pathway overlay (MAPK)
![MAPK](readme_previews/KEGG_04010_NF1KO_BYL_vs_CTRL_BYL_MAPK.png)
