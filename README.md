...
(All figures are reproducible by running the scripts in `analysis/01_deseq/`.)

#### PCA (group separation)
<img src="readme_previews/pca_group.png" alt="PCA" width="600">

#### Volcano plot (NF1KO_BYL vs CTRL_BYL)
<img src="readme_previews/volcano_NF1KO_BYL_vs_CTRL_BYL_labeled.png" alt="Volcano" width="600">

#### Hallmark GSEA dotplot
<img src="readme_previews/GSEA_Hallmark_NF1KO_BYL_vs_CTRL_BYL_dotplot.png" alt="GSEA Hallmark" width="600">

#### Heatmap of top DE genes
<img src="readme_previews/heatmap_NF1KO_BYL_vs_CTRL_BYL_top50.png" alt="Heatmap" width="600">

#### KEGG pathway overlay (MAPK)
<img src="readme_previews/KEGG_04010_NF1KO_BYL_vs_CTRL_BYL_MAPK.png" alt="KEGG MAPK" width="600">
